...
class Api::UsersControllerTest < ActionController::TestCase
  ...
  test "should create api_user" do
    assert_difference('Api::User.count') do
      post :create, api_user: { email: @api_user.email, password: @api_user.password, username: @api_user.username }
    end
  ...
  test "should update api_user" do
    patch :update, id: @api_user, api_user: { email: @api_user.email, password: @api_user.password, username: @api_user.username }
    assert_redirected_to api_user_path(assigns(:api_user))
  end
